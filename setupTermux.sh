...
echo 'alias video1080p="yt-dlp -i --add-metadata --embed-thumbnail --embed-subs --sub-langs all -S res:720"' >> /data/data/com.termux/files/usr/etc/bash.bashrc
...
echo 'alias video480p="yt-dlp -i --add-metadata --embed-thumbnail --embed-subs --sub-langs all -S res:720"' >> /data/data/com.termux/files/usr/etc/bash.bashrc
